...
I have defined the "rainy season" for this region to be from November 1st - May 31st the following year. For example, the rainy season for 2004 is from November 1st, 2003 - May 31st, 2004. To illustrate the small coverage of PRISM stations in the study area I plotted the locations of stations used for the 1981-2010 monthly data and our maximum rain gauge coverage over the region of the DEM for the study area.

```{r PRISM gauges in study area, echo=F}
psm_stations <- readOGR(dsn = "shapefiles/", layer = "psm_stations")
rg_vpoly <- readOGR(dsn = "shapefiles/", layer = "rg04_vpolys")
...
A map showing the absolute deviation between the rain gauge record and the PRISM estimate for total rainy season rainfall at the rain gauge locations.
...
rs04.lm1a <- lm(totppt_mm ~ sqrt(elev_m), data = rainy04)
rs04.lm1b <- lm(totppt_mm ~ elev_m^2, data = rainy04)
rs04.lm2 <- lm(totppt_mm ~ elev_m + d2coast, data = rainy04)
rs04.lm3 <- lm(totppt_mm ~ elev_m + d2pacific, data = rainy04)
rs04.lm3a <- lm(totppt_mm ~ sqrt(elev_m) + d2pacific, data = rainy04)
...
pairs(select(rainy05@data, totppt_mm, elev_m, lat_utm, lon_utm, psm_totppt, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
pairs(select(rainy06@data, totppt_mm, elev_m, lat_utm, lon_utm, psm_totppt, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
pairs(select(rainy07@data, totppt_mm, elev_m, lat_utm, lon_utm, psm_totppt, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
```
```{r 2008 pairs elev ols, echo=F, fig.height=8, fig.width=10}
pairs(select(rainy08@data, totppt_mm, elev_m, lat_utm, lon_utm, psm_totppt, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
```
```{r 2009 pairs elev ols, echo=F, fig.height=8, fig.width=10}
pairs(select(rainy09@data, totppt_mm, elev_m, lat_utm, lon_utm, psm_totppt, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
```
```{r 2010 pairs elev ols, echo=F, fig.height=8, fig.width=10}
pairs(select(rainy10@data, totppt_mm, elev_m, lat_utm, lon_utm, psm_totppt, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
```
```{r 2011 pairs elev ols, echo=F, fig.height=8, fig.width=10}
pairs(select(rainy11@data, totppt_mm, elev_m, lat_utm, lon_utm, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
```
```{r 2012 pairs elev ols, echo=F, fig.height=8, fig.width=10}
pairs(select(rainy12@data, totppt_mm, elev_m, lat_utm, lon_utm, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
...
```
```{r 2014 pairs elev ols, echo=F, fig.height=8, fig.width=10}
pairs(select(rainy14@data, totppt_mm, elev_m, lat_utm, lon_utm, d2pacific, d2coast),
      upper.panel = panel.cor, diag.panel = panel.hist,
