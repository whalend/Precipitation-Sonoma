...
qplot(as.numeric(year), daily_ppt, data = dy_rg_data %>% 
            group_by(id, date, year, month, day), color = id)
...
#Joing monthly precipitation data to spatial points data frame
```{r joining data}
