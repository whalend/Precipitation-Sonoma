...
ppt_other_sp <- ppt_other_sp[ppt_other_sp$station == "GlenEllen" | ppt_other_sp$station == "GlenEllenWNW",]
names(ppt_other_sp)[1:3] <- c("station", "date", "precip_mm")
summary(ppt_other_sp)
ppt_other_sp@data <- select(ppt_other_sp@data, station, date, precip_mm, lat, lon)
str(ppt_other_sp@data)
ppt_other_sp@data$date <- as.Date(ppt_other_sp@data$date)
summary(ppt_other_sp)
...
writeOGR(ppt_other_sp, "shapefiles/", "GlenEllen_ppt_2009-2015", driver = "ESRI Shapefile", overwrite_layer = T)
```
