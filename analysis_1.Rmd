...
dys_rain <- dy_rg_data %>% 
      ...
      group_by(stationid) %>% 
      summarise(rain04_dys = length(daily_ppt), rain04_avg = sum(daily_ppt)/212, rain04_tot = sum(daily_ppt))
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain05_dys = length(daily_ppt), rain05_avg = sum(daily_ppt)/211, rain05_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain06_dys = length(daily_ppt), rain06_avg = sum(daily_ppt)/211, rain06_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain07_dys = length(daily_ppt), rain07_avg = sum(daily_ppt)/211, rain07_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain08_dys = length(daily_ppt), rain08_avg = sum(daily_ppt)/212, rain08_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain09_dys = length(daily_ppt), rain09_avg = sum(daily_ppt)/211, rain09_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain10_dys = length(daily_ppt), rain10_avg = sum(daily_ppt)/211, rain10_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>% 
      summarise(rain11_dys = length(daily_ppt), rain11_avg = sum(daily_ppt)/211, rain11_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>% 
      summarise(rain12_dys = length(daily_ppt), rain12_avg = sum(daily_ppt)/212, rain12_tot = sum(daily_ppt)), by = "stationid", all = T)
...
dys_rain <- merge(dys_rain, dy_rg_data %>% 
      ...
      group_by(stationid) %>%
      summarise(rain14_dys = length(daily_ppt), rain14_avg = sum(daily_ppt)/211, rain14_tot = sum(daily_ppt)), by = "stationid", all = T)
...
filter(dys_rain, is.na(rain04_dys)) # mackie, glenellen x2, sonoma2, wunderground stations x2 (6)
filter(dys_rain, is.na(rain06_dys)) # kunde, mitsui, sugarloaf, glenellen x2, sonoma2, wunderground stations x2 (8)
filter(dys_rain, is.na(rain07_dys)) # fop, kunde, spaulding, glenellen x2, sonoma2, wunderground stations x2 (8)
filter(dys_rain, is.na(rain08_dys)) # fop, glenellen x2, sonoma2, wunderground stations x2 (6)
filter(dys_rain, is.na(rain09_dys)) # backman, cook, fop, mitsui, wunderground stations x2 (6)
filter(dys_rain, is.na(rain10_dys)) # fop, sugarloaf, kcasanta225 (3)
filter(dys_rain, is.na(rain11_dys)) # beltane, fop, mitsui, sugarloaf, votruba, kcasanta225 (6)
filter(dys_rain, is.na(rain12_dys)) # annadel, backman, beltane, fop, kunde, mitsui, sugarloaf, votruba, kcasanta225 (9)
...
summary(select(dys_rain, stationid, rain05_tot))
sd(filter(dys_rain, rain05_tot < 70)$rain05_tot, na.rm = T)
...
ggplot(data = dys_rain, aes(x = stationid, y = rain05_tot))+
      geom_point() +
      geom_abline(intercept = mean(dys_rain$rain05_tot, na.rm = T), slope = 0)
```
...
writeOGR(rg0308, dsn = "shapefiles/", layer = "rgs_0308", driver = "ESRI Shapefile")
writeOGR(rg0911, dsn = "shapefiles/", layer = "rgs_0911", driver = "ESRI Shapefile")
writeOGR(rg1214, dsn = "shapefiles/", layer = "rgs_1214", driver = "ESRI Shapefile")

rainy04 <- rg0308[!is.na(rg0308$rain04_dys),]# remove NAs for 2004 season
...
rainy05 <- rg0308[!is.na(rg0308$rain05_dys), c("stationid", "rain05_dys", "rain05_avg", "rain05_tot", "elev_m")]
rainy05@data
...
rainy06 <- rg0308[!is.na(rg0308$rain06_dys), c("stationid", "rain06_dys", "rain06_avg", "rain06_tot", "elev_m")]
...
rainy07 <- rg0308[!is.na(rg0308$rain07_dys) ,c("stationid", "rain07_dys", "rain07_avg", "rain07_tot", "elev_m")]
...
rainy08 <- rg0308[!is.na(rg0308$rain08_dys), c("stationid", "rain08_dys", "rain08_avg", "rain08_tot", "elev_m")]
rainy08@data
...
rainy09 <- rg0911[!is.na(rg0911$rain09_dys), c("stationid", "rain09_dys", "rain09_avg", "rain09_tot", "elev_m")]
rainy09@data
...
rainy10 <- rg0911[!is.na(rg0911$rain10_dys), c("stationid", "rain10_dys", "rain10_avg", "rain10_tot", "elev_m")]
rainy10@data
...
rainy11 <- rg0911[!is.na(rg0911$rain11_dys), c("stationid", "rain11_dys", "rain11_avg", "rain11_tot", "elev_m")]
rainy11@data
...
rainy12 <- rg1214[!is.na(rg1214$rain12_dys), c("stationid", "rain12_dys", "rain12_avg", "rain12_tot", "elev_m")]
rainy12@data
...
rainy14 <- rg1214[!is.na(rg1214$rain14_dys), c("stationid", "rain14_dys", "rain14_avg", "rain14_tot", "elev_m")]
rainy14@data
...
save.image("~/Documents/soco_ppt/analysis201511.RData")
```
