...
# I wasn't sure what to do from here in trying to put each data frame into the global environment. I finally hit on the right search terms ("unlist data frame R") revealing this function in an answer on Stack Overflow:
list2env(df_list, .GlobalEnv))# http://stackoverflow.com/questions/17697239/r-unlist-a-list-of-dataframes
```
