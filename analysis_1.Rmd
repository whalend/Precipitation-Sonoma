...
```{r unlist data frames into environment}
...
# I want to match on 200* EXCEPT 2009*
df_list_names <- names(df_list)
l_names <- df_list_names[grep("200[^9]", df_list_names)]
df_list_0408 <- df_list[grep("200[^9]", df_list_names)]

# Then I want to match on 20* excepting a second 0, giving me the 2010-2014 data frames, or match on 2009* to include the 2009 data frames.
l_names <- df_list_names[grep("20[^0]|2009", df_list_names)]
df_list_0914 <- df_list[grep("20[^0]|2009", df_list_names)]
```
