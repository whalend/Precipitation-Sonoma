...
rg_0308@data$elev_ft <- extract(elev, rg_0308)
str(rg_0308)
...
```{r joining data}
rg_data_temp <- inner_join(rg_0308@data, day_rg_0308, by = c("NAME" = "id"))
str(rg_data_temp)
summary(rg_data_temp)
rm(rg_data_temp)
rg_0308@data <- inner_join(rg_0308@data, day_rg_0308, by = c("NAME" = "id"))
str(rg_0308)
rg_0308$elev_m <- rg_0308$elev_ft * .305
summary(rg_0308)
```
...
qplot(rg_0308@data$elev, rg_0308@data$daily_ppt)
...
cor(rg_0308@data$elev, rg_0308@data$daily_ppt, use = "na.or.complete")


rg06 <- filter(rg_0308@data, year==2006)
