...
cor(rg_2003_2008@data$elev, rg_2003_2008@data$daily_ppt, use = "na.or.complete")
...
summary(lm_rg_0108)
plot(lm_rg_0108)
plot(rg_0108$elev, rg_0108$daily_ppt)
lm_rg_0108a <- lm(monthly_ppt ~ I(elev*100), data = rg_0108@data %>% filter(NAME != "backman"))
summary(lm_rg_0108a)
