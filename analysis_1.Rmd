...
ogrListLayers("shapefiles")# shapefiles is the name of the subfolder
...
Joining daily precipitation data to spatial points data frame
```{r joining data}
rg_data_temp <- inner_join(rg_2003_2008@data, day_rg_2003_2008, by = c("NAME" = "id"))
str(rg_data_temp)
summary(rg_data_temp)
rm(rg_data_temp)
rg_2003_2008@data <- inner_join(rg_2003_2008@data, day_rg_2003_2008, by = c("NAME" = "id"))
str(rg_2003_2008)
rg_2003_2008$elev_m <- rg_2003_2008$elev_ft * .305
...
library(ggplot2)
rg08 <- filter(rg_2003_2008@data, year==2008)
qplot(rg_2003_2008@data$elev, rg_2003_2008@data$daily_ppt)
qplot(elev_ft, daily_ppt, data = rg08, facets = month ~., color = NAME, main = "2008 Daily Rainfall")
qplot(elev_ft, daily_ppt, data = rg08 %>% filter(month==1), color = NAME, main = "January 2008 Rainfall") + geom_text(aes(label=NAME),hjust=-0.1, vjust=0)
cor(rg_2003_2008@data$elev_ft, rg_2003_2008@data$daily_ppt, use = "na.or.complete")


rg06 <- filter(rg_2003_2008@data, year==2006)
...
plot(rg_0108$elev_m, rg_0108$daily_ppt)
lm_rg_0108a <- lm(daily_ppt ~ I(elev_m*100), data = rg_0108@data %>% filter(NAME != "backman"))
summary(lm_rg_0108a)
```
