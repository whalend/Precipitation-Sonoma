...
# i - tension
# z - zscale multiplier for elevation, not sure what influence this will have
...
do
  ...
  do
    ...
    echo "Computing tension/smoothing $TNSSMTH..."
     ...
     v.vol.rst -c input=$INMAP cvdev=rain14_3d_cv_$TNSSMTH wcolumn=$WCOL tension="$i" smooth=0."$j" mask=$MASK npmin=$NPMIN segmax=700 --o
